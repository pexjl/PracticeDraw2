...
public class Practice14MaskFilterView extends View {
    ...
    private MaskFilter normalMaskFilter = new BlurMaskFilter(100, BlurMaskFilter.Blur.NORMAL);

    private MaskFilter innerMaskFilter = new BlurMaskFilter(100, BlurMaskFilter.Blur.INNER);

    private MaskFilter outterMaskFilter = new BlurMaskFilter(100, BlurMaskFilter.Blur.OUTER);

    private MaskFilter solidMaskFilter = new BlurMaskFilter(100, BlurMaskFilter.Blur.SOLID);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 第三个：OUTER
        paint.setMaskFilter(outterMaskFilter);
